                                ...
                                <tbody id="quantity-holder">
                                    <tr>
                                        <td class="cart-img-holder">
                                            <a href="#"><img src="<?php echo base_url();?>assets/img/cart1.jpg" alt="cart" class="img-responsive"></a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="cart-img-holder">
                                            <a href="#"><img src="<?php echo base_url();?>assets/img/cart2.jpg" alt="cart" class="img-responsive"></a>
                                        </td>
                                        <td>
                                            <h3><a href="#">Product Title Name</a></h3>
                                        </td>
